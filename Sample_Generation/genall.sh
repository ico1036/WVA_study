...
cfgFile=step1_${1}_${2}.py
logFile=step1_${1}_${2}.log
outrootFile="SMP-RunIISummer15wmLHEGS-00184.root"
inLHEFile="SMP-RunIISummer15wmLHEGS-00184_inLHE.root"
maxEvent=$3
firstRun=$4
firstEvent=`expr $2 \* $maxEvent + 1`
...
cfgFile=step1_${1}_${2}.py
logFile=step1_${1}_${2}.log
inrootFile="../Dir_1_0/SMP-RunIISummer15wmLHEGS-00184.root"
outrootFile="SMP-RunIISummer16DR80Premix-00276_step1.root"
...
# Revision: 1.19 
# Source: /local/reps/CMSSW/CMSSW/Configuration/Applications/python/ConfigBuilder.py,v 
# with command line options: step1 --fileout file:SMP-RunIISummer16DR80Premix-00276_step1.root --pileup_input dbs:/Neutrino_E-10_gun/RunIISpring15PrePremix-PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v2-v2/GEN-SIM-DIGI-RAW --mc --eventcontent PREMIXRAW --datatier GEN-SIM-RAW --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step DIGIPREMIX_S2,DATAMIX,L1,DIGI2RAW,HLT:@frozen2016 --nThreads 8 --datamix PreMix --era Run2_2016 --python_filename SMP-RunIISummer16DR80Premix-00276_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 720
import FWCore.ParameterSet.Config as cms
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:$inrootFile'),
...
# Production Info
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step1 nevts:$maxEvent'),
    name = cms.untracked.string('Applications'),
    version = cms.untracked.string('$Revision: 1.19 $')
)
...
'/store/mc/RunIISpring15PrePremix/Neutrino_E-10_gun/GEN-SIM-DIGI-RAW/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v2-v2/100000/A89E6087-4981-E611-AC7C-0242AC130002.root',
...
'/store/mc/RunIISpring15PrePremix/Neutrino_E-10_gun/GEN-SIM-DIGI-RAW/PUMoriond17_80X_mcRun2_asymptotic_2016_TrancheIV_v2-v2/100000/A8F5D2D6-4481-E611-A9B3-0090FAA572E0.root',
...
cfgFile=step1_${1}_${2}.py
logFile=step1_${1}_${2}.log
inrootFile="../Dir2_1_0/SMP-RunIISummer16DR80Premix-00276_step1.root"
outrootFile="SMP-RunIISummer16DR80Premix-00276_step2.root"
...
# Revision: 1.19 
# Source: /local/reps/CMSSW/CMSSW/Configuration/Applications/python/ConfigBuilder.py,v 
# with command line options: step2 --filein file:SMP-RunIISummer16DR80Premix-00276_step1.root --fileout file:SMP-RunIISummer16DR80Premix-00276.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step RAW2DIGI,RECO,EI --nThreads 8 --era Run2_2016 --python_filename SMP-RunIISummer16DR80Premix-00276_2_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 720
import FWCore.ParameterSet.Config as cms
...
# Production Info
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('step2 nevts:$maxEvent'),
    name = cms.untracked.string('Applications'),
    version = cms.untracked.string('$Revision: 1.19 $')
)
...
cfgFile=step1_${1}_${2}.py
logFile=step1_${1}_${2}.log
inrootFile="../Dir3_1_0/SMP-RunIISummer16DR80Premix-00276_step2.root"
outrootFile="SMP-RunIISummer16MiniAODv2-00278.root"
...
# Revision: 1.19 
# Source: /local/reps/CMSSW/CMSSW/Configuration/Applications/python/ConfigBuilder.py,v 
# with command line options: step1 --fileout file:SMP-RunIISummer16MiniAODv2-00278.root --mc --eventcontent MINIAODSIM --runUnscheduled --datatier MINIAODSIM --conditions 80X_mcRun2_asymptotic_2016_TrancheIV_v6 --step PAT --nThreads 8 --era Run2_2016 --python_filename SMP-RunIISummer16MiniAODv2-00278_1_cfg.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n 200
import FWCore.ParameterSet.Config as cms
