...
# with command line options: Configuration/GenProduction/python/SUS-RunIIFall18wmLHEGS-00028-fragment.py --python_filename SUS-RunIIFall18wmLHEGS-00028_1_cfg.py --eventcontent RAWSIM,LHE --customise Configuration/DataProcessing/Utils.addMonitoring --datatier GEN-SIM,LHE --fileout file:SUS-RunIIFall18wmLHEGS-00028.root --conditions 102X_upgrade2018_realistic_v11 --beamspot Realistic25ns13TeVEarly2018Collision --customise_commands process.RandomNumberGeneratorService.externalLHEProducer.initialSeed=int(46) --step LHE,GEN,SIM --geometry DB:Extended --era Run2_2018 --no_exec --mc -n 5
...
process.configurationMetadata = cms.untracked.PSet(
    annotation = cms.untracked.string('Configuration/GenProduction/python/SUS-RunIIFall18wmLHEGS-00028-fragment.py nevts:5'),
