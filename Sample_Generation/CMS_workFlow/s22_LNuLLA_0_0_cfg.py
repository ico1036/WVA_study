...
# with command line options: step2 --filein file:s2_LNuLLA_1_101.root --fileout file:s3_LNuLLA_1_101.root --mc --eventcontent AODSIM --runUnscheduled --datatier AODSIM --conditions 102X_upgrade2018_realistic_v15 --step RAW2DIGI,L1Reco,RECO,RECOSIM,EI --procModifiers premix_stage2 --era Run2_2018 --python_filename s3_LNuLLA_1_101.py --no_exec --customise Configuration/DataProcessing/Utils.addMonitoring -n -1
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:s21_LNuLLA_0_0.root'),
...
process.AODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:s22_LNuLLA_0_0.root'),
