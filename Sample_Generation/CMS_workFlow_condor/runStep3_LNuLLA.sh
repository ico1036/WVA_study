...
if [ ! -f $s2root ]; then echo "usage $0 s2_reco.root"; exit; fi

s3cfg=`basename $s3root`
s3cfg=${s3cfg/.root/.py}
...
process.source = cms.Source("PoolSource",
    fileNames = cms.untracked.vstring('file:${s2root}'),
...
process.MINIAODSIMoutput = cms.OutputModule("PoolOutputModule",
    ...
    fileName = cms.untracked.string('file:${s3root}'),
